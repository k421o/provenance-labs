...
- Author: `k421s`
- GitHub author association: `MEMBER`
...
Authority classification: **requested**, not independently proven
owner-ratified. The author identity, organization-member association, and
placement in the owning repository establish a relevant request source. They
do not alone prove the organization's internal decision authority. Promotion
to owner-ratified requires an explicit owner decision or applicable repository
governance evidence.

## Relevant observations

- The issue states a single durable body-owning path and move semantics at
